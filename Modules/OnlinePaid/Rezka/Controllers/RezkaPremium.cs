...
namespace Rezka
{
    public class RezkaPremiumController : BaseOnlineController<RezkaSettings>
    {
        ...
        public RezkaPremiumController() : base(ModInit.conf.RezkaPrem)
        {
            #region genUid
            if (machineId == null)
            {
            ...
            if (string.IsNullOrEmpty(href))
            {
                ...
                if (similar || string.IsNullOrEmpty(search.Value?.href))
                {
                    ...
                    return ContentTpl(search, () =>
                    {
                        ...
                        {
                            string link = $"{host}/lite/rhsprem?rjson={rjson}&title={enc_title}&original_title={enc_original_title}&href={HttpUtility.UrlEncode(similar.href)}";
